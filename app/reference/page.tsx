...
import { 
  ...
  CheckCircle2, AlertCircle, LayoutGrid, Ear, Mic 
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen transition-colors duration-500 bg-zinc-50 dark:bg-black text-zinc-900 dark:text-zinc-100 font-sans p-4 md:p-8 print:bg-white print:text-black print:p-0 relative">
      ...
      <main className="max-w-7xl mx-auto mb-20">
        ...
        <button 
          onClick={scrollToTop}
          className="hidden lg:flex fixed bottom-8 right-8 p-4 bg-white dark:bg-zinc-800 text-zinc-900 dark:text-white rounded-full shadow-2xl border border-zinc-200 dark:border-zinc-700 transition-all hover:-translate-y-1 hover:shadow-zinc-300/50 z-30"
